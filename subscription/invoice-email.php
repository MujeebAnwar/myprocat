      ...
      <tr>
        <td style="padding:22px 24px 6px 24px;">
          ...
          <div style="font-family:Arial, Helvetica, sans-serif; color:#333; font-size:14px; line-height:22px;">
            ...
            <?php echo htmlspecialchars($invoiceData['address_details']['AddressLine1'] ?? ''); ?>
            <?php echo htmlspecialchars($invoiceData['address_details']['City'].', ' ?? ''); ?>
             <?php echo htmlspecialchars($invoiceData['address_details']['State'].', ' ?? ''); ?>
             <?php echo htmlspecialchars($invoiceData['address_details']['ZipCode'].', ' ?? ''); ?>
            <?php echo htmlspecialchars($invoiceData['address_details']['Country'] ?? ''); ?><br>
          </div>
        </td>
      </tr>
