...
$plan = isset($_POST['plan']) ? $_POST['plan'] : 'classic';
...
$paymentTypeLabel = ($billing === 'annual' && $annualPaymentType === 'monthly') ? 'Monthly Installment 1/12' : ucfirst($billing);
...
// Get tokenized request
$tokenizedRequest = getEnvelope($xmlRequest);

// Build redirect URL for payment response
...
<body>
    <div class="payment-container">
        ...
        <?php if ($billing === 'annual' && $annualPaymentType === 'monthly' && $installments > 1): ?>
        <p style="font-size: 14px; color: #666;">First of <?php echo $installments; ?> monthly payments<br>
        <small>Total annual: $<?php echo number_format($totalAnnualAmount, 2); ?></small></p>
        <?php endif; ?>
    </div>
