...
require_once (DOCUMENT_ROOT.'/templateV2/left-sidebar.php');
require_once (DOCUMENT_ROOT.'/templateV2/right-sidebar.php');
...
$leftSidebar = new left_sidebar(
	...
	isset($sidebar_phone) ? $sidebar_phone : '+01 818 222 6600',
